...
const SiteInstallation = () => {
    ...
    return (
        <div className="site_installation_div" >
            <div>
                <div className="">
                    <h2 className="font-weight-bold">Your site is being installed right now</h2>
                    <h4 className="font-weight-bold my-3">please be patient, this may take minutes</h4>
                </div>
                <div className="d-flex justify-content-center align-items-center">
                    <img src={installationImage} style={{width:'350px', height:'350px'}} class="" alt="" />
               </div>
               <div class="progress">
