            ...
            <div className="stepper_div"> 
                <div class="row">
                    <Stepper className="w-100"  activeStep={props.activeStep}>
                        <Step label={t(`form_data.checkout`)}  onClick={()=>{props.setCurrentStep(0)}} active={props.activeStep === 0} />
                        <Step label={t(`form_data.registration_form`)} onClick={()=>{props.setCurrentStep(1)}} active={props.activeStep === 1} />
